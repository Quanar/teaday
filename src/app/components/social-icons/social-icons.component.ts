  ...
  template: `
    <div class="social-icons">
      <div class="icon-container" (click)="toggleIcons()" [class.active]="isOpen">
        <img src="assets/images/phone-solid.svg" alt=""> <!-- Иконка для открытия/закрытия -->
      </div>
      <div class="icons" [@slideInOut]="isOpen ? 'open' : 'closed'">
        <a href="https://wa.me/7079334240" class="rounded-full bg-gray-800 p-2 hover:bg-coral transition-colors">
        ...
        <a target="_blank">
          <a href="https://instagram.com/Teaday_kz" class="rounded-full bg-gray-800 p-2 hover:bg-coral transition-colors">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <!-- Instagram icon -->
